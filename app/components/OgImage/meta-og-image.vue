...
<template>
	<div
		class="w-full h-full flex justify-between relative p-[60px] bg-indigo-900 text-indigo-200"
	>
		<div
			:style="{
				width: '200%',
			...
			<div class="flex flex-row justify-between items-start">
				...
				>
					<img
						...
						class="overflow-hidden rounded-4 border-4 border-neutral-200 object-contain w-[300px] h-[300px]"
						alt="preview"
					/>
				</div>
			</div>
